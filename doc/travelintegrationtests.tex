...
\include{content/1-WorkDefinition}
\include{content/2-Recherche}
\include{content/3-AnforderungenundAnalyse}
\include{content/4-Konzept}
\include{content/5-Umsetzung}
\include{content/6-Summary}
\include{content/7-Appendix}
